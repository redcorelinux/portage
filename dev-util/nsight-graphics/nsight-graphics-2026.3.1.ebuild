...
SRC_URI="
	https://developer.nvidia.com/downloads/assets/tools/secure/${PN}/${MY_PV}/linux_x64/nvidia_${PN//-/_}_${PV}.${PV_BUILD}-linux_x64.run
...
src_prepare() {
	...
	for rpath in "${rpaths[@]}"; do
		...
		# the launcher never exports QT_PLUGIN_PATH, so the bundled Qt plugins
		# (Plugins/platforms in particular) are not found without this
		sed \
			-e "4i export QT_PLUGIN_PATH=\"\${NV_AGORA_PATH}/Plugins\"" \
